...
### [Enterprise Sovereign AI Decision Matrix](https://github.com/nepryoon/enterprise-sovereign-ai-matrix)

A deployed reference PoC for a bounded, governed agent workflow with sovereignty-aware model routing, human approval, auditable decision lineage and execution telemetry. [Live reference demonstration](https://matrix.neuromorphicinference.com/).
...
### [IADF Platform](https://github.com/nepryoon/iadf-platform)
...
- [ORCID](https://orcid.org/0009-0003-1290-1279)
- [Email](mailto:lilloluca@gmail.com)
